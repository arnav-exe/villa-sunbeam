...
<div class="p-4 bg-white rounded shadow-lg">
	<div class="flex justify-between items-center mb-4">
		<button on:click={_ => updateMonth(-1)} type="button" class="btn px-4 py-2 mr-4 variant-filled">Previous</button>

		<h3 class="h3 font-bold">{currentDate.toLocaleString("default", { month: "long" })} {currentYear}</h3>

		<button on:click={_ => updateMonth(1)} type="button" class="btn px-4 py-2 ml-4 variant-filled">Next</button>
	</div>
